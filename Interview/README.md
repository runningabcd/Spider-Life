...
### 1. a='201', b='102', a是19的三进制后的字符串,b是11的三进制后的字符串,要求:输入 a, b, 输出a+b和的三进制 比如 输入 a，b 输出'1010'
...
### 2.不使用内置函数int,输入a='201', b='102', a是19的三进制后的字符串， b是11的三进制后的字符串，输出30，要求：输入 a, b, 输出a的十进制与b的十进制之和
